    ...
    return (
      <div className="dashboard-content">
        <div style={{ display: 'flex', gap: '30px', marginBottom: '30px' }}>
          ...
          {/* VERTICAL DIVIDER */}
          <div style={{ width: '1px', backgroundColor: '#083149e0', margin: '0 10px' }}></div>

          {/* RIGHT SIDE - STUDENT LISTS */}
          <div style={{ flex: 1, minWidth: '0', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            {/* Students who didn't take the test */}
            <div className="dashboard-section" style={{ backgroundColor: '#fff3cd', border: '1px solid #ffeeba', borderRadius: '10px', padding: '15px', maxHeight: '350px', overflowY: 'auto' }}>
              ...
              {notTaken.length > 0 ? (
                ...
                <p style={{ color: '#27ae60', fontWeight: 600, margin: '0', textAlign: 'center' }}>✓ {t('allStudentsTaken', 'All took test')}</p>
              )}
            </div>
            ...
            <div className="dashboard-section" style={{ backgroundColor: '#ffe5cc', border: '1px solid #ffd6b3', borderRadius: '8px', padding: '15px', maxHeight: '350px', overflowY: 'auto' }}>
              ...
              {notPassed.length > 0 ? (
                ...
                <p style={{ color: '#27ae60', fontWeight: 600, margin: '0', textAlign: 'center' }}>✓ {t('allStudentsPassed', 'All passed')}</p>
              )}
            </div>
          </div>
        </div>
        ...
        {/* Metrics */}
        <div className="dashboard-metrics" style={{ marginTop: '30px', display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '15px' }}>
